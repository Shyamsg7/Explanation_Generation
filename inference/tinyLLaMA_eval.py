...
model_path = "./tinyllama-final-model"  # Path from SFT training
...
def format_function(examples):
    ...
    return {
        "prompt": prompts,
        "completion": examples["explanation"]  # Assuming explanation is the explanation column
    }
...
def generate_review(prompt):
    """
    Generate a review for the given prompt using the TinyLlama model.
...
results.to_csv("/home/shyamsg/Explanation_Generation/evaluation_results_tinyllama.csv", index=False)
print("Final results saved to evaluation_results_tinyllama.csv")